...
export const SignUp = inject("controller")(withRouter(class extends React.Component<ControllerProps & RouteComponentProps<any>, AppState> {
        state: AppState = {
            username: "",
            email: "",
            surname: "",
        ...
        render() {
            ...
            return (
                <div>
                    ...
                    <p>
                        To register your interest please enter your name and email below. We send weekly reminder emails to
                        members.
                    </p>
                        ...
                        <fieldset>
...

                            {
                                this.state.emailExists && <div className="Error">
                                    ...
                                    <a href='#' onClick={resendEmail}>request an email</a> you can then use to manage your
                                    profile.
                                </div>
                            }
